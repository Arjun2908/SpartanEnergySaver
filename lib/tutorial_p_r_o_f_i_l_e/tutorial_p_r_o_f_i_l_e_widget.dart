          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    'assets/images/Screen_Shot_2022-04-09_at_4.03.07_AM-removebg-preview.png',
                    width: 220,
                    height: 60,
                    fit: BoxFit.fitWidth,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Create your family so that you can get started on saving energy!',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2
                                                .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Easily add appliances and associate them with your family members.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2
                                                .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Know the status of your appliances so that you can save energy and stay safe.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2
                                                .override(
