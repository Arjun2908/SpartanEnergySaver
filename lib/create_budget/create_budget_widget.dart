                        ...
                        builder: (context, snapshot) {
                          ...
                          return FFButtonWidget(
                            onPressed: () async {
                              ...
                              await Share.share(
                                  'You have been invited to join a Smart Family! Use your unique access code now to join: 23890.');
                              Navigator.pop(context);
                              triggerPushNotification(
                                notificationTitle: 'Member Added',
                                notificationText:
                                    'Congratulations! A new member has been  added to your family',
                                userRefs: [currentUserReference],
                                initialPageName: 'MY_Budgets',
                                parameterData: {},
                              );
                            },
                            text: 'Create Member',
